    ...
    nvm_sec_cache_options_type_info = {
        {"filename",
         {offsetof(struct NVMSecondaryCacheOptions, fileName),
          ...
          OptionTypeFlags::kMutable}},
        {"filesize",
         {offsetof(struct NVMSecondaryCacheOptions, fileSize),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"device_metadata_size",
         {offsetof(struct NVMSecondaryCacheOptions, deviceMetadataSize),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"block_size",
         {offsetof(struct NVMSecondaryCacheOptions, blockSize),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"navy_req_ordering_shards",
         {offsetof(struct NVMSecondaryCacheOptions, navyReqOrderingShards),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"reader_threads",
         {offsetof(struct NVMSecondaryCacheOptions, readerThreads),
          OptionType::kUInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"writer_threads",
         {offsetof(struct NVMSecondaryCacheOptions, writerThreads),
          OptionType::kUInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"admprobability",
         {offsetof(struct NVMSecondaryCacheOptions, admProbability),
          OptionType::kDouble, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"region_size",
         {offsetof(struct NVMSecondaryCacheOptions, regionSize),
          OptionType::kUInt32T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"size_pct",
         {offsetof(struct NVMSecondaryCacheOptions, sizePct),
          OptionType::kUInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"smallitem_max_size",
         {offsetof(struct NVMSecondaryCacheOptions, smallItemMaxSize),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"bighash_bucket_size",
         {offsetof(struct NVMSecondaryCacheOptions, bigHashBucketSize),
          OptionType::kUInt32T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"bighash_bucket_bf_size",
         {offsetof(struct NVMSecondaryCacheOptions, bigHashBucketBfSize),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
};
#endif  // ROCKSDB_LITE
